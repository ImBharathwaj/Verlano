...
export default function SignupPage() {
  ...
  const handleGoogleSignIn = () => {
    signIn("google", { callbackUrl: "/api/auth/merge-cart?then=/account" });
  };
    ...
    <main className="flex min-h-[80vh] items-center justify-center py-12">
      <div className="w-full max-w-sm rounded-2xl border border-gray-soft bg-white px-6 py-8 shadow-sm">
        ...
        <p className="mt-1 text-xs text-gray-deep/80">
          Sign up to save your details and view order history. We’ll send a verification link to your email.
        </p>
        <form onSubmit={handleSubmit} className="mt-6 space-y-4">
          ...
          <div>
            <label className="mb-1 block text-xs font-medium text-gray-deep/80">Password</label>
            <input
              type="password"
              required
            ...
            />
            <p className="mt-0.5 text-[11px] text-gray-deep/70">At least 8 characters.</p>
          </div>
